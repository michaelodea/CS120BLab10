 ...
 *              Exercise Description: Modify the above example so the threeLEDs light 
 *              for 300 ms, while blinkingLED’s LED still blinks 1 second on and 1 
 *              second off.
 *
...
//DEMO: https://drive.google.com/open?id=1DWckc47XMVFDSUWbyzR_Y6hS5_-GLylh
